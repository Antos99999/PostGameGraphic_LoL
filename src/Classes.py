...
class Info:
    def __init__(self,endOfGameResult,gameCreation,gameDuration,gameEndTimestamp,gameId,gameMode,gameName,gameStartTimestamp,gameType,gameVersion,mapId,participants,platformId,queueId,teams,tournamentCode):
...
class ParticipantsId:
    def __init__(self, participantId, puuid):
        self.participantId = participantId
        self.puuid = puuid
